...
void main(){
    ...
    // these registers must be set in the correct order
    NR52_REG = 0x80; // is 1000 0000 in binary and turns on the sound 
    NR50_REG = 0x77; // sets the volume on both the left and right channel to max
    NR51_REG = 0xFF; // is 1111 1111 in binary and this sets which channels we want to use in this case all are on 1 as we wish to use them all
